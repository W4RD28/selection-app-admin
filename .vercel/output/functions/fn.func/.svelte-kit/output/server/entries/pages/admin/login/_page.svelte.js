import { c as create_ssr_component, d as compute_rest_props, a as setContext, f as spread, g as escape_object, h as escape_attribute_value, i as add_attribute, l as is_void, n as noop, v as validate_component, k as getContext, j as compute_slots } from "../../../../chunks/index2.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    $$settled = true;
    $$rendered = `${$$result.head += `<!-- HEAD_svelte-nnmafb_START -->${$$result.title = `<title>Admin Login</title>`, ""}<!-- HEAD_svelte-nnmafb_END -->`, ""}

<div><div class="pt-20 pl-20">${validate_component(Card, "Card").$$render($$result, { size: "sm", class: "self-center" }, {}, {
      default: () => {
